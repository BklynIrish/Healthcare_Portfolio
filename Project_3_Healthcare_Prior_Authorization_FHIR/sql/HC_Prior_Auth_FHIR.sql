...
LOAD DATA LOCAL INFILE '/Users/brandon_mcdermott/Documents/Healthcare_Portfolio/Project_3_Healthcare_Prior_Authorization_FHIR/data/source/authorization_requests.csv'
...
SET
    ...
    decision_at = NULLIF(@decision_at, ''),
    authorization_number = NULLIF(@authorization_number, ''),
